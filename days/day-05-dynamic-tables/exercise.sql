/*
Day 5: Dynamic Tables - Exercises
...
-- ============================================================================
-- Exercise 1: Create Basic Dynamic Table (5 min)
-- ============================================================================

-- TODO: Create a Dynamic Table that aggregates daily sales
...
-- TODO: Query the Dynamic Table
-- SELECT * FROM daily_sales_summary ORDER BY sale_date;

-- TODO: Show Dynamic Tables
-- SHOW DYNAMIC TABLES;

-- TODO: Check refresh history
-- SELECT *
...
-- ============================================================================
-- Exercise 2: Configure TARGET_LAG (5 min)
-- ============================================================================

-- TODO: Create Dynamic Table with 1 minute lag
...
-- TODO: Create Dynamic Table with 1 hour lag
...
-- TODO: Insert new data to trigger refresh
-- INSERT INTO sales_raw (sale_id, product_id, customer_id, amount, quantity, sale_date) VALUES
--   (6, 102, 1001, 59.98, 2, '2025-12-04');

-- TODO: Check which table refreshes faster
-- Wait a minute and query both tables
-- SELECT * FROM product_sales_1min;
-- SELECT * FROM product_sales_1hour;

-- TODO: Change TARGET_LAG
-- ALTER DYNAMIC TABLE product_sales_1min SET TARGET_LAG = '10 minutes';


-- ============================================================================
-- Exercise 3: Multi-Layer Pipeline (10 min)
-- ============================================================================

-- TODO: Layer 1 - Clean and filter sales
...
-- TODO: Layer 2 - Enrich with product information
...
-- TODO: Query the final layer
-- SELECT * FROM category_summary;

-- TODO: View the pipeline dependencies
-- SHOW DYNAMIC TABLES;


-- ============================================================================
-- Exercise 4: Incremental vs. Full Refresh (10 min)
-- ============================================================================

-- TODO: Create Dynamic Table with incremental refresh (simple aggregation)
...
-- TODO: Create Dynamic Table with full refresh (window function)
...
-- TODO: Check refresh mode in history
-- SELECT 
--   dynamic_table_name,
--   refresh_action,
--   refresh_start_time,
...
-- ============================================================================
-- Exercise 5: Monitor Refresh History (5 min)
-- ============================================================================

-- TODO: View all Dynamic Table refreshes
-- SELECT 
--   dynamic_table_name,
--   refresh_action,
--   state,
...
-- TODO: Check current lag for all Dynamic Tables
-- SELECT 
--   name as table_name,
--   target_lag,
--   data_timestamp,
...
-- TODO: Identify tables that are behind schedule
-- SELECT 
--   name,
--   target_lag,
--   DATEDIFF(second, data_timestamp, CURRENT_TIMESTAMP()) as current_lag_seconds,
...
-- TODO: Calculate credit usage by Dynamic Table
-- SELECT 
--   dynamic_table_name,
...
-- TODO: Compare incremental vs full refresh costs
-- SELECT 
--   dynamic_table_name,
--   refresh_action,
--   COUNT(*) as refresh_count,
...
-- ============================================================================
-- Exercise 7: Dynamic Tables vs. Materialized Views (5 min)
-- ============================================================================
...
-- TODO: Insert new data and observe refresh behavior
-- INSERT INTO sales_raw (sale_id, product_id, customer_id, amount, quantity, sale_date) VALUES
--   (7, 103, 1002, 159.98, 2, '2025-12-04');

-- Wait and query both again to see refresh differences


-- ============================================================================
-- Bonus Challenge: Production Pipeline (10 min)
-- ============================================================================

-- TODO: Build a complete production-ready pipeline
